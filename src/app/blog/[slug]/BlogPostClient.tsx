        ...
        >
          <div
            className="prose prose-lg max-w-none
              ...
              prose-h2:text-4xl prose-h2:mt-20 prose-h2:mb-8 prose-h2:leading-tight prose-h2:pb-4 prose-h2:border-b prose-h2:border-black/10
              prose-h3:text-2xl prose-h3:mt-14 prose-h3:mb-5 prose-h3:leading-snug
              prose-h4:text-xl prose-h4:mt-10 prose-h4:mb-4
              prose-p:text-[17px] prose-p:text-gray-700 prose-p:leading-[1.8] prose-p:mb-6
              ...
              prose-li:text-[17px] prose-li:text-gray-700 prose-li:leading-[1.75] prose-li:pl-8 prose-li:relative
              prose-li:before:content-['•'] prose-li:before:absolute prose-li:before:left-2 prose-li:before:text-black prose-li:before:font-bold
              prose-ol>li:before:content-none
              prose-a:text-black prose-a:underline prose-a:underline-offset-4 prose-a:decoration-2 prose-a:font-medium
              hover:prose-a:text-gray-600 hover:prose-a:decoration-gray-400
              prose-blockquote:border-l-4 prose-blockquote:border-black prose-blockquote:pl-8 prose-blockquote:py-2 prose-blockquote:my-8 prose-blockquote:italic prose-blockquote:text-gray-800 prose-blockquote:bg-gray-50
              ...
              [&_section]:my-16 [&_section]:first:mt-0
              [&_section>h2]:mt-0
              [&_section>p:first-of-type]:text-[18px] [&_section>p:first-of-type]:leading-[1.9]"
