...
const products = {
  '1': { name: "SHADOW CHAIN", price: 100 },
  '2': { name: "OBSIDIAN RING", price: 80 },
  '3': { name: "MIDNIGHT BEANIE", price: 40 },
  '4': { name: "VOID GLOVES", price: 60 },
  '5': { name: "ONYX BELT", price: 120 }
}
    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <main className="pt-24 pb-24">
        <div className="max-w-7xl mx-auto px-8">
          <div className="mb-12">
            <Link href="/arc-2/accessories" className="text-xs text-gray-500 hover:text-white transition-colors uppercase tracking-wider">
