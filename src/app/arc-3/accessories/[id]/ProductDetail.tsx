...
const products = {
  '1': {
    ...
    price: 142,
    category: "Jewelry",
    description: "Sterling silver chain with polished finish. 24-inch length, 5mm width. Subtle elegance without the noise.",
    details: [
      "925 sterling silver with high polish",
    ...
    story: "Jewelry should enhance, not overpower. The Pearl Chain is refined silver that catches light quietly. It's the chain you wear every day because it works with everything. Simple, classic, timeless."
  },
  '2': {
    name: "IVORY RING",
    price: 92,
    category: "Jewelry",
    description: "Minimalist band ring in brushed silver. Understated piece that goes with everything.",
    details: [
  ...
  '3': {
    ...
    price: 52,
    category: "Headwear",
    description: "Soft merino wool beanie in natural. Lightweight construction, warm performance.",
    details: [
      "100% merino wool (200 GSM)",
      "One size fits most",
      "Ribbed knit",
      "Fold-over cuff",
      "Minimal branding",
    ...
    story: "A beanie should be soft, warm, and easy. The Cloud Beanie is all three. Lightweight merino that doesn't overheat, classic fit that works for everyone. It's the beanie that becomes your daily."
  },
  '4': {
    name: "FROST GLOVES",
    price: 82,
    category: "Accessories",
    description: "Touchscreen gloves in light grey. Warm, functional, minimal.",
    details: [
      "Merino wool blend with tech fibers",
    ...
    story: "Gloves don't need to be complicated. The Frost Gloves are warm merino with touchscreen fingers. No bulk, no fuss. Just function wrapped in quality materials."
  },
  '5': {
    name: "CHALK BELT",
    price: 122,
    category: "Accessories",
    description: "Italian leather belt in natural tan. 35mm width, minimalist buckle. Ages beautifully.",
    details: [
    ...
    story: "A good belt lasts decades. The Chalk Belt is natural vegetable-tanned leather that gets better with age. Minimal buckle, quality construction. The kind of piece you pass down."
  }
}
...
export function ProductDetail({ id }: { id: string }) {
    ...
    return (
      <div className="bg-white text-black min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/arc-3/accessories" className="text-gray-400 hover:text-black underline">
            Back to Arc 3 Accessories
          </Link>
        </div>
      </div>
    )
  ...
  const getSizes = () => {
    if (id === '2') return ["7", "8", "9", "10", "11", "12"]
    if (id === '5') return ["28", "30", "32", "34", "36", "38", "40", "42"]
    return ["ONE SIZE"]
  }
    ...
    <div ref={containerRef} className="bg-white text-black min-h-screen relative">
      ...
      <main className="pt-32 pb-24 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <Link href="/arc-3/accessories" className="group inline-flex items-center gap-2 text-xs text-gray-400 hover:text-black transition-colors uppercase tracking-[0.2em]">
              <motion.span
              ...
              <span>Back to Arc 3 Accessories</span>
            </Link>
          </motion.div>
