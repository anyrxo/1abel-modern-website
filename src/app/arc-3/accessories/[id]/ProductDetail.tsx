...
const products = {
  ...
  '2': { name: "IVORY RING", price: 80 },
  '3': { name: "CLOUD BEANIE", price: 40 },
  '4': { name: "FROST GLOVES", price: 60 },
  '5': { name: "CHALK BELT", price: 120 }
}
    ...
    <div className="bg-white text-black min-h-screen">
      ...
      <main className="pt-24 pb-24">
        <div className="max-w-7xl mx-auto px-8">
          <div className="mb-12">
            <Link href="/arc-3/accessories" className="text-xs text-gray-500 hover:text-black transition-colors uppercase tracking-wider">
