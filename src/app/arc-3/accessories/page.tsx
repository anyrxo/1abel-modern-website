          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-500 max-w-xl mx-auto leading-relaxed">
                Refined finishing touches that complete your aesthetic. Minimal,
                intentional pieces designed to elevate without overpowering.
              </p>
            </motion.div>
          </motion.div>
      ...
      {/* Products Grid */}
          ...
          >
            {filteredProducts.map((product, index) => (
              ...
              >
                <Link href={`/arc-3/accessories/${product.slug}`} className="group block">
                  {/* Product Image */}
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-400 mt-1">1 signature color</p>
                  </div>
      ...
      {sortMenuOpen && (
        <>
          ...
          <motion.div
            ...
            animate={{ y: 0 }}
            transition={{ type: 'spring', damping: 30, stiffness: 300 }}
            className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-premium-xl p-6 pb-8"
          >
            <h3 className="text-lg font-bold tracking-wider uppercase mb-6 text-black">Sort By</h3>
