...
const products = {
  '1': { name: "CLOUD THERMAL", price: 100 },
  '2': { name: "ETERNAL HOODIE", price: 130 },
  '3': { name: "FROST ZIPUP", price: 130 },
  '4': { name: "IVORY HOODIE", price: 130 },
  '5': { name: "ARCTIC PUFFER", price: 200 },
  '6': { name: "PEARL THERMAL", price: 100 },
  '7': { name: "CHALK SWEATER", price: 130 },
  '8': { name: "LUNAR TEE", price: 65 }
}
    ...
    <div className="bg-white text-black min-h-screen">
      ...
      <main className="pt-24 pb-24">
        <div className="max-w-7xl mx-auto px-8">
          <div className="mb-12">
            <Link href="/arc-3/tops" className="text-xs text-gray-500 hover:text-black transition-colors uppercase tracking-wider">
              ← Back to Arc 3 Tops
            </Link>
          </div>
