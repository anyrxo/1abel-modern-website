      ...
      <main className="pt-24 pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
          ...
          >
              ...
              <div className="group cursor-pointer">
                <div className="aspect-[3/4] bg-gray-50 mb-4 relative overflow-hidden border border-gray-200">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-6xl font-bold tracking-tighter opacity-10 group-hover:opacity-20 transition-opacity">
                      TOPS
                    </span>
                  </div>
                </div>
            ...
            <Link href="/arc-3/accessories">
              <div className="group cursor-pointer">
                <div className="aspect-[3/4] bg-gray-50 mb-4 relative overflow-hidden border border-gray-200">
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-all duration-500" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-5xl font-bold tracking-tighter opacity-10 group-hover:opacity-20 transition-opacity">
                      ACCESS
                    </span>
                  </div>
                </div>
