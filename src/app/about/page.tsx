      ...
      <section className="py-20 px-4 bg-gradient-to-r from-gray-900/20 to-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a href="mailto:anyro@1abel.com" className="bg-white text-black hover:bg-gray-200 px-12 py-4 rounded-lg text-lg font-semibold transition-colors inline-block">
              Email Us
            </a>
            <Link href="/contact">
