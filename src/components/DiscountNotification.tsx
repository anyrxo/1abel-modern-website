  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          {/* Glass morphism card */}
          <div className="relative overflow-hidden rounded-3xl backdrop-blur-2xl bg-gradient-to-br from-white/90 to-white/70 border border-white/20 shadow-2xl">
            ...
            <div className="relative p-6">
              ...
              >
                <div className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-500 shadow-lg">
...
export function DiscountSuggestion({ code, message, onApply, applied }: DiscountSuggestionProps) {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl backdrop-blur-xl bg-gradient-to-br from-yellow-50/90 to-orange-50/90 border border-yellow-200/50 p-4 shadow-lg"
    >
      {/* Animated background */}
      ...
      <div className="relative flex items-center justify-between gap-4">
        ...
        {!applied ? (
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-6 py-2 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-sm font-bold shadow-lg hover:shadow-xl transition-shadow"
          >
            Apply
          </motion.button>
        ) : (
          <div className="px-4 py-2 rounded-full bg-green-500 text-white text-xs font-bold flex items-center gap-1">
