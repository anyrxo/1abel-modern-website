...
# Common fixes for all accessory reviews
fixes = [
    # Username fixes - remove underscores
    (r"author: '([a-zA-Z]+)_([a-zA-Z0-9]+)'", r"author: '\1\2'"),
    
    # Period to comma fixes in content (but not at end)
    (r"content: '([^'\.]+)\. ([^']+)'", r"content: '\1, \2'"),
    
    # Capitalization fixes at start of content
    ...
    (r"content: 'Cannot ", r"content: 'cannot "),
...
print("Fixed all remaining accessory reviews")
